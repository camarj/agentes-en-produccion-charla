...
- **Veredicto en la demo:** en esta demo el veredicto **se muestra tal como salga, aunque sea `failed`**. La lección de la charla es iterar con evals, no maquillarlas: no se bajan umbrales ni se tocan guardrails para que pase. En Studio se ve la progresión de los experimentos del 2026-09-25 (27/40 → 28 → 32 → 32 → 35; detalle en `.claude/sessions/ITERACION-EVALS.md`). Se corrieron en local y se importan al Studio de producción como el dataset «charla-v1 · iteración 2026-09-25» (`pnpm importar:experimentos`, DEPLOY.md §6.1).
...
| D8 | 2026-09-25 | Solo la corrida final de cada paso va a Studio de producción (corridas en local, importadas con `pnpm importar:experimentos` al dataset «charla-v1 · iteración 2026-09-25»). Progresión: 27/40 → 28 → 32 → 32 (ver `.claude/sessions/ITERACION-EVALS.md` para las corridas posteriores) | T13 | Mostrar la iteración real sin ruido | T13, demo paso 3 |
