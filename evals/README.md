...
- **En la demo** el veredicto se muestra **tal como salga, aunque sea `failed`** (decisión de Raúl, 2026-09-25; PRD §11 y §15 #46). No se bajan umbrales ni se tocan guardrails para que pase: se itera de verdad y cada paso deja un experimento en Studio (Datasets → `charla-v1` → Experiments). Los cinco de la iteración del 2026-09-25 se corrieron en local y se llevan al Studio de producción con `pnpm importar:experimentos` (dataset «charla-v1 · iteración 2026-09-25»; ver DEPLOY.md §6.1). La progresión y las fallas que quedan están en `.claude/sessions/ITERACION-EVALS.md`.
