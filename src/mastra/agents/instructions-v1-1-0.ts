// Instrucciones 1.1.0 CONGELADAS (tono cercano, Raúl 2026-09-23): el texto
// exacto que usaba el agente antes de la 1.2.0 (git 540fe53). Existe solo para
// comparar versiones con el mismo dataset en Studio
// (`pnpm evals -- --instrucciones 1.1.0`).
...
export const VERSION_INSTRUCCIONES_1_1_0 = "1.1.0";
...
export function construirInstrucciones110(ctx: ContextoInstrucciones | undefined): string {
